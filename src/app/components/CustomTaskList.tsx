...
// 🚀 담당자(기획), 담당자(IT) 칼럼 넓이 +5% (110px) 확장 적용
const COL_WIDTHS = {
  area: 65, 
  phase: 85, 
  activity: 160, 
  deliverable: 140, 
  taskName: 200,      
  assigneePlan: 110,  // 105 -> 110
  assigneeIT: 110,    // 105 -> 110
  start: 80, 
  end: 80, 
  progress: 60,
  status: 75,
...
export const CustomTaskListHeader: React.FC<any> = ({ headerHeight, rowWidth, fontFamily, fontSize }) => {
  ...
  // 좌측 헤더 기준 색상: 배경 bg-[#CFD8DC], 외곽선 border-slate-400(#94A3B8), 텍스트 text-slate-800(#1E293B)
  ...
  return (
    <div className="bg-white">
      {tasks.map((t: any) => {
        ...
        // 좌측 셀 테두리 기준 색상: border-slate-300(#CBD5E1)
        ...
        return (
          // 좌측 호버 색상: bg-blue-50/70 = rgba(239, 246, 255, 0.7)
